    ...
    for date in date:
        ...
        for g in range(0, subfolder_count):
            ...
            for file_name in files:
                ...
                forcetension2 = np.random.uniform(1.2, 2)
                extension2 = np.random.uniform(30, 100)
                forcetension3 = np.random.uniform(1.2, 2)
                extension3 = np.random.uniform(30, 100)

                if point2-point1>60 and point3 - point2>60:
                    ...
                    force_poly_2 = np.concatenate(
                        [force_part_1, force_part_3, force_part_5, force_part_6])

                    distance_poly_2 = np.concatenate(
                        [distance_part_1, distance_part_3, distance_part_5, distance_part_6])
            ...
            if len(force_ploy_noise_data_list) >0:
                ...
                np.save('E:/dataset/simulation_data/transfor/' + str(date) + '_force_ploy_noise_3_1000__' + str(run)+ '__.npy',
                        force_ploy_noise_data_vstack)
                np.save('E:/dataset/simulation_data/transfor/' + str(date) + '_distance_ploy_noise_3_1000__' + str(run) + '__.npy',
