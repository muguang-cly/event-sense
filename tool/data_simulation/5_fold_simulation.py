    ...
    for date in date:
        ...
        for g in range(0, subfolder_count):
            ...
            for file_name in files:
                ...
                if point2-point1>40 and point3 - point2>40 and point4 - point3>40 and point5 - point4>40:
                    ...
                    force_poly_2 = np.concatenate(
                        [force_part_1, force_part_3, force_part_5, force_part_7,force_part_9,force_part_10])

                    distance_poly_2 = np.concatenate(
                        [distance_part_1, distance_part_3, distance_part_5, distance_part_7,distance_part_9,distance_part_10])
            ...
            if len(distance_ploy_noise_data_list) >0:
                ...
                np.save('E:/dataset/simulation_data/transfor/' + str(date) + '_force_ploy_noise_5_1000--' + str(run)+ '.npy',
                        force_ploy_noise_data_vstack)
                np.save('E:/dataset/simulation_data/transfor/' + str(date) + '_distance_ploy_noise_5_1000--' + str(run) + '.npy',
